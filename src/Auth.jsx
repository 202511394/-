...
// Supabase 클라이언트 초기화 (본인의 프로젝트 환경에 맞춰 사용 중이신 값 확인)
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans pb-24">
      ...
      <main className="max-w-5xl mx-auto px-4 pt-6 space-y-6">
        ...
        <div className="pt-4 flex justify-between items-center border-t border-slate-800/80">
          <span className="text-xs text-slate-500">서비스 이용을 중단하고 싶으신가요?</span>
          <button 
            onClick={handleDeleteAccount}
            className="flex items-center gap-1.5 px-4 py-2 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 text-xs font-semibold rounded-xl transition-colors border border-rose-500/20"
          >
            <UserX size={14} /> 회원탈퇴
          </button>
        </div>
